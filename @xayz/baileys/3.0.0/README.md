...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=32&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=%40xayz%2Fbaileys;by+XYCoolcraft;WhatsApp+Web+%2B+Node.js" alt="@xayz/baileys typing banner" />
...
<p align="center">
  <!-- Code-screenshot placeholder — replace with a real carbon.now.sh / ray.so export of the snippet above -->
  <img src="https://placehold.co/760x360/0d1117/58a6ff?text=%3Cyour+carbon.now.sh+code+screenshot+here%3E" width="620" alt="quick start code screenshot placeholder" />
</p>
...
<p align="center">
  <img src="https://placehold.co/760x220/0d1117/22c55e?text=%3Cpairing-code+terminal+GIF+placeholder%3E" width="620" alt="pairing code demo placeholder" />
</p>
...
`@xayz/baileys` is XYCoolcraft's fork of a fork:
...
- Intermediate fork: PouCode.
- This fork's rebranding, packaging, and the changes described in
  [`LITERACY.md`](LITERACY.md#changelog-vs-upstream): **XYCoolcraft**.
...
Made with 💜 by **XYCoolcraft** · [`README.md`](README.md) · [`LITERACY.md`](LITERACY.md)
