...
<p align="center">
  <img
    src="https://carbon.now.sh/?bg=rgba%28171%2C+184%2C+195%2C+1%29&t=seti&wt=none&l=auto&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=import%2520makeWASocket%2520from%2520%27%2540xayz%252Fbaileys%27%253B%250A%250Aconst%2520sock%2520%253D%2520makeWASocket%28%257B%250A%2520%2520printQRInTerminal%253A%2520true%250A%257D%29%253B%250A%250Asock.ev.on%28%27connection.update%27%252C%2520%28update%29%2520%253D%253E%2520%257B%250A%2520%2520console.log%28%27connection%2520update%253A%27%252C%2520update%29%253B%250A%257D%29%253B"
    width="620"
