...
const makeWASocket = (config) => {
    ...
    // AntiBan — OFF by default. Opt in with `antiban: true` (uses the
    // 'aggressive' preset), `antiban: '<preset>'`, or a full config object.
    ...
    // — sock.antiban is simply undefined when not enabled.
